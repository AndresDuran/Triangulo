...
public class InterfazTriangulo extends JFrame {
    ...
    public InterfazTriangulo( )
    {
        ...
        punto1.inicializar( 120, 120 );

        //Crea el punto 2
        Punto punto2 = new Punto( );
        punto2.inicializar( 120, 180 );

        //Crea el punto 1
        Punto punto3 = new Punto( );
        punto3.inicializar( 180, 180 );

        //Inicializa el color del relleno en Azul
     
        interfaz.Color colorRelleno = new interfaz.Color( );
        colorRelleno.inicializar( 0, 0, 170 );

        //Inicializa el color de las líneas en negro
        
        interfaz.Color colorLineas = new interfaz.Color( );
